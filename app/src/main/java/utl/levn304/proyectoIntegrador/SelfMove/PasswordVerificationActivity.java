...
public class PasswordVerificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvResend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(PasswordVerificationActivity.this, "Código reenviado (demo)", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(pin1) || TextUtils.isEmpty(pin2) || TextUtils.isEmpty(pin3) || TextUtils.isEmpty(pin4)) {
                    Toast.makeText(PasswordVerificationActivity.this, "Completa el código de verificación", Toast.LENGTH_SHORT).show();
                    return;
                }
                // Aquí iría la lógica real de verificación
                Toast.makeText(PasswordVerificationActivity.this, "Código verificado (demo)", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(PasswordVerificationActivity.this, NewPasswordActivity.class);
